...
if(isset($_GET["search"])){
    ...
    $sql = "SELECT * FROM product WHERE category='Electronics' AND (product.name LIKE ? OR product.description LIKE ?)";
          ...
          <div class="row">
               ...
               <div class="col-md-4 mb-4">
                    <div class="card" style="width: 18rem;">
                         ...
                         <img src="./image2/<?= htmlspecialchars($product['name']); ?>.jpg" class="card-img-top" alt="Electronics Image">
                         <div class="card-body">
